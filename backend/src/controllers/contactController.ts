...
import { ContactRequestModel, ContactRequest } from '../models/ContactRequest';
import { validateContactRequest } from '../middleware/validation';
...
export class ContactController {
  ...
  static async getAllRequests(req: Request, res: Response) {
    try {
      ...
      const result = await ContactRequestModel.findAll(page, limit);
  ...
  static async getRequestById(req: Request, res: Response) {
    try {
      ...
      const request = await ContactRequestModel.findById(id);
